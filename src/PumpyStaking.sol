...
import {IERC721} "@openzeppelin/contracts/token/ERC721/IERC721.sol";
import "./interfaces/IPumpyStaking.sol";

contract PumpStaking {
    ...
    function stakePump(uint256 nftId, uint256 amount) external {
        require(pumpNFT.ownerOf(nftId) == msg.sender, "Not the owner of the NFT");
    ...
    function claimRewards() external {
        ...
        require(pumpToken.transfer(msg.sender, rewardAmount), "Failed to transfer rewards");
    ...
    function unstake() external {
        ...
        require(pumpToken.transfer(msg.sender, amount), "Failed to transfer tokens");
